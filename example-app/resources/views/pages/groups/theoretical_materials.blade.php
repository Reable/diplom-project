            ...
            @if(isset($materials[0]))
                <div class="mt-10 flex flex-col gap-8">
                    @foreach($materials as $material)
                        <a href="{{ route("groups_theoretical_materials_download", [$group["id"], $session["id"], $material["id"]]) }}"
