...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('main_page', function (Blueprint $table) {
            ...
            $table->boolean("methodical_works_show")->default(0);  // паказывать ли блок методических работ? (true/false)
            $table->json("methodical_works_ids")->nullable();                   // список методических работ, лимит 4
